      ...
      <div className="row">
        <div className="col-sm-4">
          <div className="image-wrapper">
            ...
            <img src={image} className="image-position"/>
            <ProgressBar
              className="progress-bar"
              percent={progress}
              color="#2D9CDB"/>
            <small className="percent">{progress}% complete</small>
          </div>
        </div>
        <div className="col-sm-8 card-info">
          ...
          <h5 className="contractors">Contractors</h5>
          {
            contractorPicture.map((picture) => (
              <img src={picture.picture} key={picture.picture} className="contractor-pic"/>
            ))
          }
